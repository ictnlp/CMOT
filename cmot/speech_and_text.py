...
from fairseq.data.audio.speech_and_text_dataset import (
    S2TDataConfig,
    SpeechAndTextDataset,
    SpeechAndTextDatasetCreator,
)
...
@register_task("speech_and_text")
class SpeechAndTextTask(LegacyFairseqTask):
    @classmethod
    def add_args(cls, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            metavar="N",
            help="max number of tokens in the source raw audio sequence",
        )
        parser.add_argument(
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = SpeechAndTextDatasetCreator.from_tsv(
            self.args.data,
            self.data_cfg,
            split,
            self.tgt_dict,
    ...
    def build_model(self, args, from_checkpoint=False):
        ...
        return super(SpeechAndTextTask, self).build_model(args, from_checkpoint)
    ...
    def build_generator(
        ...
        lang_token_ids = {
            ...
            if SpeechAndTextDataset.is_lang_tag(s)
        }
